...
public class PrincipalF
{
	...
	public static void main(String[] args)
	{
		...
		/*obp.Accion(obp.Entrada(obp.Separar("obp.Accion(obp.Entrada(obp.Separar("Programa name { int var , id2 ; float f ; var = ( 5 * 4 ) + ( 2 * 4 ) ; id2 = read ; switch [ var ] "
				+ "{ case 1 : var = 'X' ; break case 2 : var = 'Y' ; break  Default : var = 'Z' ; break } "
				+ "while [ id2 >= 4.01 ] { id2 = id2 + 1 ; } }")));")));*/
		 /*obp.Accion(obp.Entrada(obp.Separar("Programa prog  {"
		 		+ " int a , b , c ;"
		 		+ " float d , e , f ;"
		 		+ " char c1 , c2 , c3 ;"
		...
		//obp.Accion(obp.Entrada(obp.Separar("Programa name { int a ; a = a ; while [ a <= 1 ] { a = a + 1 ; } }")));
		obp.mostrarSimbolos();
	}
