...
public class Principal
{
	...
	{
		//nota: todos los elementos cada ves q salgan, si concuerda con el primer elemento de la entrada ingresada por el usuario
		//se mandaran al codigo intermedio al menos q sea una asignacion ya q esa se necesita modificar para su orden posfijo
		int zt;
		//Termina asignacion
		...
		if(pilaT.getLast().equals("I17") || banAsig)
		{
			...
			if(entrada.get(pos).equals(cad))
			{
				...
				val.Elemento(entraUser.get(pos));//manda los elementos a validacion
			}
