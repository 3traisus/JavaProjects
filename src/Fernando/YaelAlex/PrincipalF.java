...
public class PrincipalF
{
	...
	{
		//Termina asignacion
		/*if((pilaT.getLast().equals("I18") && cad.equals(";"))
				|| (pilaT.getLast().equals("I34") && cad.equals(";")))*/
		...
		//Empieza asignacion
		if(pilaT.getLast().equals("I07") || banAsig)
		{
			val.Datos(datos);
			banAsig = true;
	...
	public void mostrar()
	{
		System.out.println("Mostrar Pila Semantica");
	...
	public static void main(String[] args)
	{
		...
		obp.Accion(obp.Entrada(obp.Separar("int a , g ; float b ; char c ;  b = 5 / 5 ;")));
  	} 
}
